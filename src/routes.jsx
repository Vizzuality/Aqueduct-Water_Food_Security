...
const Routes = ({ history }) => (
  <Router history={history}>
    <Route path="/" component={App}>
      <IndexRoute components={{ header: () => <Header title="Water Food Security" appRoute="https://www.wri.org/applications/aqueduct/food/" />, main: MapPage }} onEnter={onEnterMapPage} />
      <Route path="compare">
        <IndexRoute components={{ header: () => <Header title="Water Food Security" appRoute="https://www.wri.org/applications/aqueduct/food/" />, main: ComparePage }} onEnter={onEnterComparePage} />
      </Route>
      <Route path="embed">
